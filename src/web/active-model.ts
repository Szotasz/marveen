 ...
 *
 * This is the fleet's cheapest "when did this session last do anything"
 * signal, and the honest one: Claude Code appends to the jsonl on every turn,
 * so the file's mtime is written BY the session, from outside our process. A
 * clock kept in the dashboard's memory dies with the dashboard, and a
