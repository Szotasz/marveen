...
import { enrollAuthorizedKey, type EnrollResult } from '../remote-enroll-fs.js'
...
// removeBridgeSshAccess lives in remote-enroll-fs.ts in this fork; it is
// re-exported from there and imported by routes/auth.ts for DELETE revocation.
