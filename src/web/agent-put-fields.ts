...
// indistinguishable from success. Measured 2026-08-11 against the live
// dashboard:
//
...
//
// That is the securityProfile failure above, one endpoint over: a whole fleet
// was configured for a tier that does not exist and every call reported success.
//
