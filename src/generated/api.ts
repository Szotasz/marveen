...
export interface Error {
  ...
  error: 'admin_must_be_global' | 'cannot_disable_default_tenant' | 'cannot_disable_self' | 'conflict' | 'display_name_required' | 'federated_sender_not_allowed' | 'federation_disabled' | 'federation_self_reference' | 'forbidden' | 'internal_error' | 'invalid_federated_address' | 'invalid_recipient_format' | 'invalid_sender_id' | 'invalid_tenant_id' | 'invalid_value' | 'last_admin' | 'limit_exceeded' | 'managed_settings_missing' | 'message_not_found' | 'missing_required_fields' | 'no_fields' | 'not_found' | 'not_supported' | 'parse_error' | 'partner_sender_already_exists' | 'partner_sender_not_found' | 'password_too_short' | 'required' | 'role_invalid' | 'sender_id_is_fleet_agent' | 'sender_not_in_allowlist' | 'sender_reserved' | 'tenant_already_exists' | 'tenant_id_required' | 'tenant_not_found' | 'tenant_required_for_non_admin' | 'timeout' | 'unauthorized' | 'unknown_federation_peer' | 'unknown_sender' | 'upstream_error' | 'user_not_found' | 'username_invalid' | 'username_taken';
