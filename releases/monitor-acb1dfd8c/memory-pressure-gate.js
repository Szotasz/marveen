...
function logGuardAbsenceOnce(reason, detail) {
    if (hasLoggedGuardAbsence)
        return;
    hasLoggedGuardAbsence = true;
    logger.warn({ reason, detail }, "Memory-pressure gate is absent on this host — non-core agent starts are NOT blocked by it. " +
...
export function __resetGuardAbsenceLogForTest() {
