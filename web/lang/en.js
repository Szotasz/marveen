...
window._i18n.en = {
  ...
  'kanban.modal.decisions_title': 'Decisions',
  'kanban.decision.pending':     'Awaiting decision',
  'kanban.decision.answered':    'Decided',
  'kanban.decision.answered_none': 'None of these',
  'kanban.decision.none':        'None of these',
  'kanban.decision.note_placeholder': 'Reason (optional)',
  'kanban.decision.saved':       'Decision recorded',
  'kanban.decision.error':       'Could not record the decision',
  ...
  'costs.project_shared':        'Shared (several projects)',
  'costs.project_untagged':      'Untagged',
  'costs.project_money':         'Real cost',
  'costs.project_ai':            'AI (list-price equivalent, USD)',
  'costs.project_ai_note':       'The AI column is not an invoice: it is what the same token volume would cost at published API rates. It is NOT added to the real cost, because the subscription paying for it is already counted there.',
  'costs.fx_missing':            'Missing exchange rate:',
  'costs.fx_missing_note':       'these items are shown in their own currency and are NOT included in the total. Add the rate in the cost config.',
  'costs.fx_asof':               'Rates as of:',
  'costs.no_projects':           'No project-level costs yet.',
  ...
  'settings.desc.KANBAN_ARCHIVED_MAX_ROWS':    'How many archived cards the archive view loads at once. This is a display limit only: nothing is deleted, and archived cards are kept indefinitely. Hard ceiling 5000.',
  ...
  'kanban.modal.blockers_title': 'Dependencies',
  'kanban.blocker.add_ph':       '#12 or card id',
  'kanban.blocker.add_btn':      '+ Blocker',
  'kanban.blocker.waiting_for':  'Waiting for:',
  'kanban.blocker.blocking':     'Waiting for this card:',
  'kanban.blocker.none':         'No dependencies',
  'kanban.blocker.remove':       'Remove dependency',
  'kanban.blocker.card_tooltip': 'Blocked by: {list}',
  'kanban.blocker.added':        'Dependency added',
  'kanban.blocker.removed':      'Dependency removed',
