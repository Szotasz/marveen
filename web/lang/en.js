...
window._i18n.en = {
  ...
  'systemCron.page_subtitle':    'Read-only view of the system crontab entries (crontab -l)',
  'systemCron.readonly_note':    'Read-only. These are the system crontab (crontab -l) entries; they cannot be edited here.',
  'systemCron.col.schedule':     'Cron expression',
  'systemCron.col.next':         'Next run',
  'systemCron.col.command':      'Command',
  'systemCron.col.comment':      'Comment',
  'systemCron.empty':            'No system cron entries',
  'systemCron.error':            'Failed to load system cron.',
  'systemCron.unavailable':      'This view is Linux-only. macOS schedules via launchd (not yet supported).',
