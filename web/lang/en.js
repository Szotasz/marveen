...
window._i18n.en = {
  ...
  'agents.wizard.pending_title': 'Your agent is ready, but its personality is not',
  'agents.wizard.pending_body':  'Generating CLAUDE.md and SOUL.md did not succeed, so what you see below is a template. The agent itself was created and works, nothing was lost. You can rewrite it here now, or leave it and regenerate later.',
  'agents.wizard.pending_detail': 'Cause: {detail}',
