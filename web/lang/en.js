...
window._i18n.en = {
  ...
  'agents.channel.tg_howto_remove':     'To remove, use the X button in the Connected Chats list.',
  ...
  'agents.auth.flow_desc':           'Starts the /login command in the agent tmux session and returns the auth URL.',
