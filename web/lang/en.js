...
window._i18n.en = {
  ...
  'settings.claude_plans.intro':  'Registered Claude subscriptions (plans). A plan is backed either by a pasted OAuth token (claude setup-token output, sk-ant-oat01-…; stored encrypted in the vault, never in plain text on disk) or by an already-logged-in, persistent CLAUDE_CONFIG_DIR. For token-mode plans the dashboard checks 5-hour and 7-day usage live. Automatic key rotation is controlled by the toggle below; its prerequisites are listed in the toggle description.',
  ...
  'settings.claude_plans.token_mode': 'token (vault)',
  'settings.claude_plans.status.ok': 'OK',
  'settings.claude_plans.status.warn': 'near limit',
  'settings.claude_plans.status.exhausted': 'exhausted',
  'settings.claude_plans.resets': 'resets in {d} ({at})',
  'settings.claude_plans.checked': 'last checked: {age}',
  'settings.claude_plans.never_checked': 'not checked yet',
  'settings.claude_plans.check_now': 'Check now',
  ...
  'settings.claude_plans.probe_error.no_usage_headers': 'last check: no usage data in the response',
  ...
  'settings.claude_plans.form.error_required': 'Id and label are required.',
  'settings.claude_plans.form.error_token_required': 'Token mode needs a token.',
  'settings.claude_plans.form.error_config_dir_required': 'CLAUDE_CONFIG_DIR mode needs a path.',
  'settings.claude_plans.form.title_add':   'Add a plan',
  'settings.claude_plans.form.title_edit':  'Edit plan: {id}',
  'settings.claude_plans.form.mode':        'Authentication',
  'settings.claude_plans.form.mode_token':  'OAuth token (pasted)',
  'settings.claude_plans.form.mode_config_dir': 'CLAUDE_CONFIG_DIR (logged-in folder)',
  'settings.claude_plans.form.token':       'OAuth token',
