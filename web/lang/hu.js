...
window._i18n.hu = {
  ...
  'kanban.modal.decisions_title': 'Döntések',
  'kanban.decision.pending':     'Döntésre vár',
  'kanban.decision.answered':    'Eldöntve',
  'kanban.decision.answered_none': 'Egyik sem',
  'kanban.decision.none':        'Egyik sem',
  'kanban.decision.note_placeholder': 'Indoklás (nem kötelező)',
  'kanban.decision.saved':       'Döntés rögzítve',
  'kanban.decision.error':       'A döntést nem sikerült rögzíteni',
  ...
  'costs.fx_converted_at':       'a {date} napon jegyzett árfolyamon került átváltásra',
  'costs.fx_no_asof':            'az árfolyam dátuma ismeretlen',
  'costs.by_project':            'Projektenként',
  'costs.project':               'Projekt',
  'costs.project_shared':        'Közös (több projekt)',
  'costs.project_untagged':      'Címkézetlen',
  'costs.project_money':         'Valós költség',
  'costs.project_ai':            'AI (lista-ár ekvivalens, USD)',
  'costs.project_ai_note':       'Az AI-oszlop nem számla, hanem lista-ár ekvivalens: ennyibe kerülne ugyanez a token-mennyiség publikált API-áron. A valós költséghez NEM adódik hozzá, mert az előfizetés már szerepel ott.',
  'costs.fx_missing':            'Hiányzó árfolyam:',
  'costs.fx_missing_note':       'ezek a tételek a saját devizájukban szerepelnek, és nincsenek beleszámolva az összegbe. Add meg az árfolyamot a költség-konfigurációban.',
  'costs.fx_asof':               'Árfolyamok dátuma:',
  'costs.no_projects':           'Nincs projekt-szintű költség.',
  ...
  'settings.desc.KANBAN_ARCHIVED_MAX_ROWS':    'Az archivált kártya-nézet egyszerre ennyi kártyát tölt be. Ez csak megjelenítési korlát: semmi nem törlődik, az archivált kártyák korlátlan ideig megmaradnak. Felső határ 5000.',
  ...
  'kanban.modal.blockers_title': 'Függőségek',
  'kanban.blocker.add_ph':       '#12 vagy kártya-id',
  'kanban.blocker.add_btn':      '+ Blokkoló',
  'kanban.blocker.waiting_for':  'Erre vár:',
  'kanban.blocker.blocking':     'Erre a kártyára vár:',
  'kanban.blocker.none':         'Nincs függőség',
  'kanban.blocker.remove':       'Függőség törlése',
  'kanban.blocker.card_tooltip': 'Blokkolva: {list}',
  'kanban.blocker.added':        'Függőség hozzáadva',
  'kanban.blocker.removed':      'Függőség törölve',
