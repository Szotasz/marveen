...
window._i18n.hu = {
  ...
  'settings.claude_plans.intro':  'Regisztrált Claude-előfizetések (planek). Egy plan vagy egy beillesztett OAuth tokenre (claude setup-token kimenete, sk-ant-oat01-…; titkosítva a vaultba kerül, nyíltan sosem íródik lemezre), vagy egy már bejelentkezett, tartós CLAUDE_CONFIG_DIR-re épül. Token-módú plannél a dashboard élőben ellenőrzi az 5 órás és 7 napos keret kihasználtságát. Az automata kulcs-rotációt a lenti kapcsoló vezérli, az előfeltételeit a kapcsoló leírása mondja ki.',
  ...
  'settings.claude_plans.status.ok': 'rendben',
  'settings.claude_plans.status.warn': 'közel a limithez',
  'settings.claude_plans.status.exhausted': 'elfogyott',
  'settings.claude_plans.resets': 'nullázódik {d} múlva ({at})',
  'settings.claude_plans.checked': 'utoljára ellenőrizve: {age}',
  'settings.claude_plans.never_checked': 'még nem volt ellenőrizve',
  'settings.claude_plans.check_now': 'Ellenőrzés most',
  ...
  'settings.claude_plans.probe_error.no_usage_headers': 'utolsó ellenőrzés: a válaszban nem volt keret-adat',
  ...
  'settings.claude_plans.form.error_required': 'Az azonosító és a címke kötelező.',
  'settings.claude_plans.form.error_token_required': 'Token-módban a token kötelező.',
  'settings.claude_plans.form.error_config_dir_required': 'CLAUDE_CONFIG_DIR módban az útvonal kötelező.',
  'settings.claude_plans.form.title_add':   'Új plan felvétele',
  'settings.claude_plans.form.title_edit':  'Plan szerkesztése: {id}',
  'settings.claude_plans.form.mode':        'Hitelesítés',
  'settings.claude_plans.form.mode_token':  'OAuth token (beillesztve)',
  'settings.claude_plans.form.mode_config_dir': 'CLAUDE_CONFIG_DIR (bejelentkezett mappa)',
